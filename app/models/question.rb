class Question < ApplicationRecord
  ...
  # liked the question
  # through - this argument defines which model is used for the join (i.e. the
  # table that has a reference to the user and the question)
  # source - this argument defines what is the target reference fromm the like model
